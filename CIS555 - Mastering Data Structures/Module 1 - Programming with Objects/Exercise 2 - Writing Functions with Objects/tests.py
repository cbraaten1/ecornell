...
def test_add_time2():
    ...
    # Feel free to add more
    time1 = clock.Time(5,30)
    time2 = clock.Time(3,40)
    ...
    # Verify that objects are correct
    introcs.assert_equals(9,time1.hours)
    introcs.assert_equals(10,time1.minutes)
    introcs.assert_equals(3,time2.hours)
    introcs.assert_equals(40,time2.minutes)
