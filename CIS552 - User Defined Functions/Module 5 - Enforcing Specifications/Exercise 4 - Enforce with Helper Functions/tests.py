...
def test_iso_8601():
    """
    Test procedure for iso_8601
    """
    print('Testing iso_8601')

    # Put your tests below this line
    result = funcs.iso_8601('00:00:00')
    introcs.assert_equals(True,result)

    result = funcs.iso_8601('12:35:15')
    introcs.assert_equals(True,result)

    result = funcs.iso_8601('3:302:05')
    introcs.assert_equals(False,result)

    result = funcs.iso_8601('33:0:205')
    introcs.assert_equals(False,result)

    result = funcs.iso_8601('aa:59:59')
    introcs.assert_equals(False,result)

    result = funcs.iso_8601('23:aa:59')
    introcs.assert_equals(False,result)

    result = funcs.iso_8601('23:59:aa')
    introcs.assert_equals(False,result)
