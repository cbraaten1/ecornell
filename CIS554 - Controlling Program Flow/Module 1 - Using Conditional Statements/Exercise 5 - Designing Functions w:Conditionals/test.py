...
def test_valid_format():
    ...
    result = func.valid_format('10,00,000')
    introcs.assert_equals(False,result)

    result = func.valid_format('4,')
    introcs.assert_equals(False,result)

    result = func.valid_format('17,')
    introcs.assert_equals(False,result)

    result = func.valid_format('918,')
    introcs.assert_equals(False,result)

    result = func.valid_format(',8')
    introcs.assert_equals(False,result)

    result = func.valid_format('9,1')
    introcs.assert_equals(False,result)

    result = func.valid_format('66,9')
    introcs.assert_equals(False,result)
